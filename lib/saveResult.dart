...
class SaveResultPage extends StatefulWidget {
  final int id;

  const SaveResultPage({Key? key, required this.id}) : super(key: key);

  @override
  _SaveResultPageState createState() => _SaveResultPageState();
}

class _SaveResultPageState extends State<SaveResultPage> {
  ...
  Future<void> fetchResultData() async {
    final response = await http.post(
      Uri.parse('http://172.20.10.2/flutter_login/saveResult.php'),
  ...
  Future update() async {
    String url = "http://172.20.10.2/flutter_login/delete.php";
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: const Color.fromARGB(
                              255, 0, 0, 0), // ใช้สีที่เข้มขึ้นเพื่อโดดเด่น
                        ),
                      ),
                      SizedBox(height: 10),
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: Color.fromARGB(255, 250, 0,
                              0), // เปลี่ยนสีให้เป็นสีน้ำเงินเข้มเพื่อเพิ่มความน่าสนใจ
                          shadows: [
                            Shadow(
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: Color.fromARGB(
                              255, 250, 0, 0), // สีที่สว่างกว่าบางส่วน
                          fontWeight: FontWeight.w600,
                        ),
                      ),
                      SizedBox(height: 20),
